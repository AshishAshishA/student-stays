...
class RoomFor(models.Model):

    room_for = models.CharField(max_length=30)

    def __str__(self):
        return self.room_for
...
class Room(models.Model):
    ...
    lat_bath = models.CharField(max_length=200, default='attached/separate')                            #change 1
    ...
    room_for = models.ForeignKey(RoomFor, on_delete=models.SET_NULL, blank=True, null=True)               #3
